...
public class SimpleQueueServiceSample {
    ...
    public SimpleQueueServiceSample()
    {
        try {
    ...
    void pushMessage(String tweetText)
    {
        // Send a message
        System.out.println("Sending a message to MyQueue." + tweetText+"\n");
        sqs.sendMessage(new SendMessageRequest(myQueueUrl, tweetText));
    }
}
